    ...
    function ClientMainCtrl($scope, $rootScope, $state, $mdSidenav, $mdMedia, $mdDialog, gettextCatalog, UserService,
        ...
        */
        ...
        $scope.selectGraphCartography = function () {
          data = [
            {y: 0, x: 0, value: null, color: "#D6f107"},
            {y: 0, x: 1, value: null, color: "#D6f107"},
            {y: 0, x: 2, value: null, color: "#D6f107"},
            {y: 0, x: 3, value: null, color: "#D6f107"},
            {y: 0, x: 4, value: null, color: "#D6f107"},
            {y: 0, x: 5, value: null, color: "#D6f107"},
            {y: 0, x: 6, value: null, color: "#D6f107"},
            {y: 0, x: 8, value: null, color: "#D6f107"},
            {y: 0, x: 9, value: null, color: "#D6f107"},
            {y: 0, x: 10, value: null, color: "#D6f107"},
            {y: 0, x: 12, value: null, color: "#D6f107"},
            {y: 0, x: 15, value: null, color: "#D6f107"},
            {y: 0, x: 16, value: null, color: "#D6f107"},
            {y: 0, x: 20, value: null, color: "#D6f107"},
            {y: 1, x: 0, value: null, color: "#D6f107"},
            {y: 1, x: 1, value: null, color: "#D6f107"},
            {y: 1, x: 2, value: null, color: "#D6f107"},
            {y: 1, x: 3, value: null, color: "#D6f107"},
            {y: 1, x: 4, value: null, color: "#D6f107"},
            {y: 1, x: 5, value: null, color: "#D6f107"},
            {y: 1, x: 6, value: null, color: "#D6f107"},
            {y: 1, x: 8, value: null, color: "#D6f107"},
            {y: 1, x: 9, value: null, color: "#FFBC1C"},
            {y: 1, x: 10, value: null, color: "#FFBC1C"},
            {y: 1, x: 12, value: null, color: "#FFBC1C"},
            {y: 1, x: 15, value: null, color: "#FFBC1C"},
            {y: 1, x: 16, value: null, color: "#FFBC1C"},
            {y: 1, x: 20, value: null, color: "#FFBC1C"},
            {y: 2, x: 0, value: null, color: "#D6f107"},
            {y: 2, x: 1, value: null, color: "#D6f107"},
            {y: 2, x: 2, value: 1, color: "#D6f107"},
            {y: 2, x: 3, value: null, color: "#D6f107"},
            {y: 2, x: 4, value: 2, color: "#D6f107"},
            {y: 2, x: 5, value: null, color: "#FFBC1C"},
            {y: 2, x: 6, value: 5, color: "#FFBC1C"},
            {y: 2, x: 8, value: null, color: "#FFBC1C"},
            {y: 2, x: 9, value: 10, color: "#FFBC1C"},
            {y: 2, x: 10, value: null, color: "#FFBC1C"},
            {y: 2, x: 12, value: 6, color: "#FFBC1C"},
            {y: 2, x: 15, value: 2, color: "#FD661F"},
            {y: 2, x: 16, value: 4, color: "#FD661F"},
            {y: 2, x: 20, value: null, color: "#FD661F"},
            {y: 3, x: 0, value: 4, color: "#D6f107"},
            {y: 3, x: 1, value: null, color: "#D6f107"},
            {y: 3, x: 2, value: null, color: "#D6f107"},
            {y: 3, x: 3, value: null, color: "#FFBC1C"},
            {y: 3, x: 4, value: 3, color: "#FFBC1C"},
            {y: 3, x: 5, value: null, color: "#FFBC1C"},
            {y: 3, x: 6, value: 20, color: "#FFBC1C"},
            {y: 3, x: 8, value: 1, color: "#FFBC1C"},
            {y: 3, x: 9, value: 24, color: "#FFBC1C"},
            {y: 3, x: 10, value: 3, color: "#FD661F"},
            {y: 3, x: 12, value: 12, color: "#FD661F"},
            {y: 3, x: 15, value: 5, color: "#FD661F"},
            {y: 3, x: 16, value: 3, color: "#FD661F"},
            {y: 3, x: 20, value: null, color: "#FD661F"},
            {y: 4, x: 0, value: null, color: "#D6f107"},
            {y: 4, x: 1, value: null, color: "#D6f107"},
            {y: 4, x: 2, value: 1, color: "#D6f107"},
            {y: 4, x: 3, value: null, color: "#FFBC1C"},
            {y: 4, x: 4, value: 3, color: "#FFBC1C"},
            {y: 4, x: 5, value: null, color: "#FFBC1C"},
            {y: 4, x: 6, value: 13, color: "#FFBC1C"},
            {y: 4, x: 8, value: 1, color: "#FD661F"},
            {y: 4, x: 9, value: null, color: "#FD661F"},
            {y: 4, x: 10, value: null, color: "#FD661F"},
            {y: 4, x: 12, value: 2, color: "#FD661F"},
            {y: 4, x: 15, value: null, color: "#FD661F"},
            {y: 4, x: 16, value: null, color: "#FD661F"},
            {y: 4, x: 20, value: null, color: "#FD661F"},
          ];
          options = {
            xLabel:"Likelihood",
            yLabel:"Impact"
