    ...
    .factory('HorizontalBarChartService', function (){
      ...
      */
      ...
      function draw(tag, data, parameters){
        ...
        x.domain([0, d3v5.max(values)]).nice();
        ...
        var category = svg.selectAll(".category")
          ...
          .enter().append("g")
            ...
            .attr("transform",function(d) { return `translate(1,0)`; })
        ...
        category.append("rect")
            ...
            .attr("y", (d) => { return y(d.category); })
            .style("fill", (d) => { return setColor(d) })
            .attr("x", () => { return x(0); })
            .attr("width", () => { return x(0); });
        ...
        if (options.showValues) {
          category.append("text")
              .attr("dx", "1em")
              .attr("transform", d => { return `translate(${x(0)},${y(d.category)})`; })
          ...
          category.selectAll("text")
            .transition()
            .attr("transform", d => { return `translate(${x(d.value)},${y(d.category)})`; })
            .attr("opacity", 1)
            .duration(500);
        }
